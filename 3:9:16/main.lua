...
--physics.addBody(gear2,"dynamic",{radius=100})



--local knobJ = physics.newJoint("weld",gear1,knob,w*0.25,h*0.45)

local pivot1 = physics.newJoint("pivot",gear1,staticBox,w*0.25,h/2)
pivot1.isMotorEnabled=true
pivot1.MotorSpeed=10000
pivot1.maxMotorTorque=1000000

local pivot2 = physics.newJoint("pivot",gear2,staticBox,w*0.5,h/2)

--local gearJoint = physics.newJoint("gear",gear1,gear2,pivot1,pivot2,1)
